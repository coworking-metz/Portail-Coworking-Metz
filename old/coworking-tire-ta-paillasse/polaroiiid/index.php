			...
			<div class="row">
				<div class="col-lg-6 offset-lg-3 col-12">
					<form method="post" class="form shadow mt-3 p-3" enctype="multipart/form-data">
                        ...
                        <?php endif; ?>
                        <p class="text-center">Choisissez <strong>une photo </strong>, renseignez les informations et 'Générez votre Polaroïd'.
                        </p>
						<div class="mb-3">
							<label for="picture_file" class="form-label">Choisissez une photo</label>
							<input class="form-control" type="file" id="picture_file" name="picture" accept="image/*" />
						</div>
						<div class="mb-3">
							<input type="text" class="form-control" id="username" name="username" placeholder="Prénom & Nom ou nom de la structure * "
								   value="<?php echo strip_tags($data['username']); ?>" maxlength="36" required />
						</div>
						<div class="mb-3">
							<input type="text" class="form-control" id="job" name="job" maxlength="36" placeholder="Ligne 1 "
								   value="<?php echo htmlspecialchars(strip_tags($data['job'])); ?>"  />
						</div>
                        <div class="mb-5">
							<input type="text" class="form-control" id="job2" name="job2" maxlength="40" placeholder="Ligne 2 (si besoin)"
