	...
	*/
    ...
    public static function serviceListAsNano()
    {
		...
		foreach($resultArray as $item){
			...
			$output 			.= '<div data-service-id="'.$item['id1'].'" data-category-id="'.$item['id2'].'" data-employee-id="'.$employeeIDs.'" data-location-id="'.$locationList.'" data-capacity-min="'.$item['capacity_min'].'" data-capacity-max="'.$item['capacity_max'].'">'.$item['title'].'</div>';
		}
