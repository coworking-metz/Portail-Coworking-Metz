					...
					<div class="help_wrap">
						<div class="help_inner">
							...
							<div class="help_list">
								<ul>
									<li>
										<a href="http://bookmify.frenify.com/1/how-to-install/" target="_blank">
											<span class="icon">
									...
									<li>
										<a href="http://bookmify.frenify.com/1/faq/" target="_blank">
											<span class="icon">
...
//									</div>';
	...
	public static function bookmifyAdminContentEnd(){
		$html  = '<div class="bookmify_be_footer"><a href="http://bookmify.frenify.com/1/changelog/" target="_blank" title="'.esc_attr__('View changelog', 'bookmify').'">'.esc_html__('v', 'bookmify').BOOKMIFY_VERSION.'</a></div>';
		$html .= '</div></div></div>';				
		return $html;
	}
}