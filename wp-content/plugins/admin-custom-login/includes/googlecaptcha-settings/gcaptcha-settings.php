				...
				<tr class="radio-span">
					<td>
						<span>
							...
							?>
							 />&nbsp;<?php esc_html_e( 'Enable', WEBLIZAR_ACL ); ?><br>
						</span>
						<span>
							...
							if ( $login_enable_gcaptcha == 'no' ) {
								echo esc_attr( 'checked' );}
							?>
							 />&nbsp;<?php esc_html_e( 'Disable', WEBLIZAR_ACL ); ?><br>
						</span>
					...
					<td>
						<span>
							...
							if ( $login_v_gcaptcha == 'v2' ) {
								echo esc_attr( 'checked' );}
							?>
							 />&nbsp;<?php esc_html_e( 'v2', WEBLIZAR_ACL ); ?><br>
						</span>
						<span>
							...
							if ( $login_v_gcaptcha == 'v3' ) {
								echo esc_attr( 'checked' );}
							?>
							 />&nbsp;<?php esc_html_e( 'v3', WEBLIZAR_ACL ); ?><br>
						</span>
					...
					<td>
						<span>
							...
							if ( $acl_gcaptcha_theme == 'yes' ) {
								echo esc_attr( 'checked' );}
							?>
							 />&nbsp;<?php esc_html_e( 'Light', WEBLIZAR_ACL ); ?><br>
						</span>
						<span>
							...
							if ( $acl_gcaptcha_theme == 'no' ) {
								echo esc_attr( 'checked' );}
							?>
							 />&nbsp;<?php esc_html_e( 'Dark', WEBLIZAR_ACL ); ?><br>
						</span>
					</td>
				</tr> 
