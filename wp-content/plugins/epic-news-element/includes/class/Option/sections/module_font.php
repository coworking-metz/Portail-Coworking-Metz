...
$options[] = array(
	...
	'output'      => array(
		array(
			'method'  => 'typography',
			'element' => '.jeg_post_title, .jeg_post_title > a, jeg_archive_title, .jeg_block_title>span, .jeg_block_title>span>strong'
		)
	)
);
...
$options[] = array(
	...
	'output'      => array(
		array(
			'method'  => 'typography',
			'element' => '.jeg_post_meta, .jeg_postblock .jeg_subcat_list > li > a:hover, .jeg_pl_md_card .jeg_post_category a, .jeg_postblock .jeg_subcat_list > li > a, .jeg_pl_md_5 .jeg_post_meta, .jeg_post_category a'
		)
	)
);
