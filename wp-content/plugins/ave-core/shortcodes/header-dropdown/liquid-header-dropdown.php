...
* LD_Shortcode
*/
class LD_Header_Dropdown extends LD_Shortcode { 
	...
	public function __construct() {
		...
		// Properties
		$this->slug        = 'ld_header_dropdown';
		$this->title       = esc_html__( 'Header Dropdown', 'ave-core' );
	...
	public function get_params() {
		...
		$this->params = array(
			array(
				'type'        => 'textfield',
				'param_name'  => 'trigger_label',
				'heading'     => esc_html__( 'Trigger Label', 'ave-core' ),
				'description' => esc_html__( 'Add trigger label to dropdown', 'ave-core' ),
				'admin_label' => true,
			...
			*/
			...
			array(
				...
				'description' => esc_html__( 'Select Data source of the menu', 'ave-core' ),
				'value'       => array(
