...
= 1.2.13 - Released on 30 June 2021 =

* New: support for WordPress 5.8
* New: support for WooCommerce 5.5
* Update: YITH plugin framework
* Update: language files
* Tweak: prevent creating statuses with the same slug of others

= 1.2.12 - Released on 1 June 2021 =

* New: support for WooCommerce 5.4
* Update: YITH plugin framework
* Update: language files

= 1.2.11 - Released on 10 May 2021 =

* New: support for WooCommerce 5.3
* Update: YITH plugin framework
* Update: language files

= 1.2.10 - Released on 15 April 2021 =

* New: support for WooCommerce 5.2
* Update: YITH plugin framework
* Update: language files
* Tweak: fixed string textdomain

= 1.2.9 - Released on 5 March 2021 =
...
= 1.2.8 - Released on 1 February 2021 =

* New: support for WooCommerce 5.0
* Update: YITH plugin framework
* Update: language files

= 1.2.7 - Released on 30 Dec 2020 =

* New: support for WooCommerce 4.9
* Update: plugin framework
* Update: language files

= 1.2.6 - Released on 02 Dec 2020 =

* New: support for WordPress 5.6
* New: support for WooCommerce 4.8
* New: support for YITH Frontend Manager for WooCommerce 1.6.16
* Update: plugin framework
* Update: language files

= 1.2.5 - Released on 03 Nov 2020 =

* New: support for WooCommerce 4.7
* Update: plugin framework
* Update: language files

= 1.2.4 - Released on 06 Oct 2020 =

* New: support for WooCommerce 4.6
* Update: plugin framework
* Update: language files

= 1.2.3 - Released on 17 Sep 2020 =

* New: support for WooCommerce 4.5
* Update: plugin framework
* Update: language files
* Fix: wrong attribute used for the filter 'woocommerce_can_reduce_order_stock'
* Dev: new filter 'yith_wccos_order_preview_actions'

= 1.2.2 - Released on 03 Jul 2020 =

* New: support for WooCommerce 4.3
* New: show custom order statuses in order preview actions
* Update: plugin framework
* Update: language files
