...
if ( ! class_exists( 'YITH_Plugin_Upgrade' ) ) {
	...
	class YITH_Plugin_Upgrade {
		 ...
		 * @var string
		 */
		protected $remote_url = 'https://apanha.yithemes.com/plugin-xml.php';
		 ...
		 * @var string
		 */
		protected $package_url = 'https://apanha.yithemes.com/api/download/';
		...
		public function __construct() {
			...
			if ( defined( 'YIT_LICENCE_DEBUG' ) && YIT_LICENCE_DEBUG ) {
				$this->package_url = defined( 'YIT_LICENCE_UPGRADE_LOCALHOST' ) ? YIT_LICENCE_UPGRADE_LOCALHOST : 'https://apanha-licenceyithemes.kinsta.cloud/api/download/';
